...
def bufferedBoundary(region):
    """Returns polygons that contain a given region, with a 25km buffer around the region boundaries
    ...
    return countryGDF.to_crs(crs=3857).buffer(25000).to_crs(crs=4326)
